            ...
            <div class="col-lg-4 col-md-6 col-sm-8 mx-auto">
              <div v-if="!registerActive" class="card login" v-bind:class="{ error: emptyFields }">
                ...
                <form class="form-group">
                  ...
                  <p>No tienes cuenta? <a href="#" @click="registerActive = !registerActive, emptyFields = false">Registrate aquí</a></p>
              ...
              <div v-else class="card register" v-bind:class="{ error: emptyFields }">
                ...
                <form class="form-group">
                  ...
                  <p>Ya tienes cuenta?<a href="#" @click="registerActive = !registerActive, emptyFields = false">  Iniciar sesión</a></p>
                </form>
              </div>
            </div>
          </div>
